...
public class MenDianRandomUtil {
    ...
    public static String getRandomAddress() {
        ...
        String[] home = {"金色家园", "耀江花园", "阳光翠竹苑", "东新大厦", "溢盈河畔别墅", "真新六街坊", "和亭佳苑", "协通公寓", "博泰新苑", "菊园五街坊", "住友嘉馨名园", "复华城市花园", "爱里舍花园", "蓝光金悦", "中海国际", "环球广场", "时代广场", "万达广场", "四和小区", "和美家园", "心仪花园", "中德L区"};
        Random random = new Random();
        int randomRoadNum = random.nextInt(road.length);
        int randomHomeNum = random.nextInt(home.length);
        int num = random.nextInt(200);
        int dong = random.nextInt(20);
        int lou = random.nextInt(33);
        int hao = random.nextInt(12);

        return road[randomRoadNum] + num + "号" + home[randomHomeNum] + dong + "栋" + lou + "楼" + hao + "号";
    }
